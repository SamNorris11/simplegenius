...
<head>
<meta charset="utf-8">
<title>Your Competitive Landscape Brief: ${esc(company)}</title>
<style>${css}</style>
</head>
<body>
...
<div class="cover-inner">
  ...
  <div class="rule"></div>
  <div class="brief-title">Your Competitive Landscape Brief</div>
...
<div class="page interior">
  <div class="hdr">
    <div class="hdr-icon"><img src="${icon}"> <span>Your Competitive Landscape Brief</span></div>
