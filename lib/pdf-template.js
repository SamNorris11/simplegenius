...
function sourcePill(finding) {
  ...
  return `<a class="source-pill" href="${href}"><b>SOURCE</b> ${label} \u2197</a>`;
}
...
<head>
<meta charset="utf-8">
<title>Your Simple Genius Brief: ${esc(company)}</title>
<style>${css}</style>
</head>
<body>
...
<div class="cover-inner">
  ...
  <div class="rule"></div>
  <div class="brief-title">Your Simple Genius Brief</div>
...
<div class="cover-nav">
  <div class="cover-nav-label">Inside this brief</div>
...
<div class="page interior">
  <div class="hdr">
    <div class="hdr-icon"><img src="${icon}"> <span>Your Simple Genius Brief</span></div>
...
<div class="page close-page">
  <div class="body-area" style="padding-top:0;">
    ...
    <div class="close-intro">You gave us your company and two competitors. Everything in this brief came from publicly available information.</div>
    ...
    <a class="close-cta" href="https://simplegenius.com">See Simple Genius with the full picture &rarr;</a>
