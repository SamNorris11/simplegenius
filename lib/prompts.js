...
3. At most 5 "comparison_categories" — each comparing target vs comp1 vs comp2 on one strategically meaningful axis (e.g. "Public AI messaging", "Geographic footprint", "Positioning clarity", "Recent public moves"). Never a category built from identifying trivia (address, phone, founding date) with no strategic content. Never invent a category with no supporting research. Each of "target", "competitor_1", and "competitor_2" in a comparison_categories row MUST be a single sentence, under 160 characters. These render in a fixed-height table cell — longer text will be cut off, so keep it tight.
