...
async function renderPdfFromHtml(html) {
  ...
  // @sparticuz/chromium v149 ships as an ES module; a CommonJS require()
  // throws ERR_REQUIRE_ESM. puppeteer-core is CJS-compatible either way, but
  // dynamic import() works for both from a CommonJS file.
