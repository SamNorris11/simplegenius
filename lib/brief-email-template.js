...
function renderBriefReadyEmail({ firstName, pdfUrl, email }) {
  ...
  const subject = 'Your Simple Genius Brief is ready';
...
<p style="margin:0 0 20px 0;font-family:Arial, Helvetica, sans-serif;line-height:26px;color:#1D1D1D;font-size:16px">Your Simple Genius Brief is ready.</p>
...
Your Simple Genius Brief is ready.
