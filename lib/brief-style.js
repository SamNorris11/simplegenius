...
.cfind-tag-col .tag-pill { font-size: 7.2pt; letter-spacing: 0.05em; padding: 3.5px 9px; max-width: 100%; white-space: normal; word-break: break-word; line-height: 1.25; text-align: center; }
.source-pill {
  display: inline-flex;
  align-items: center;
  flex-shrink: 0;
