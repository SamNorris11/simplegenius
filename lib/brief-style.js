...
.cfind-tag-col .tag-pill { letter-spacing: 0.04em; padding: 3.5px 8px; max-width: 100%; white-space: nowrap; line-height: 1.25; text-align: center; }
.source-pill {
  display: inline-flex;
  align-items: center;
  flex-shrink: 0;
...
.cfind-tag-col { width: 1.3in; flex-shrink: 0; padding-top: 2px; }
...
.compare-table tbody tr:first-child td, .compare-table tbody tr:first-child th { padding-top: 6px; }
